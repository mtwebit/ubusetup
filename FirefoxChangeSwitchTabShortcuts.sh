#!/bin/bash
# Taken from https://github.com/nilcons/firefox-hacks
...
+    <key id="gregzilla_prevTab" key="1" modifiers="alt" oncommand="gBrowser.tabContainer.advanceSelectedTab(-1, true);" reserved="true"/>
+    <key id="gregzilla_prevTab" key="2" modifiers="alt" oncommand="gBrowser.tabContainer.advanceSelectedTab(1, true);" reserved="true"/>
+
